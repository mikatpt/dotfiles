...
c.keys = {
    ...
    ctrl_tmux('DownArrow', act.ActivateKeyTable(resize)),
    ctrl_tmux('UpArrow', act.ActivateKeyTable(resize)),
    tmux('DownArrow', act.ActivateKeyTable(resize)),
    tmux('UpArrow', act.ActivateKeyTable(resize)),
