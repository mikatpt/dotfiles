...
nnoremap <leader><S-P><S-F> <CMD>lua require'telescope.builtin'.live_grep({ prompt_title = 'Find Text', layout_strategy = 'vertical', search_dirs = require'harpoon.finderui'.search_dirs() })<CR>
